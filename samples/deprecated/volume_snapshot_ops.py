...
def volume_snapshotop_sequential(url):
    ...
    step1_snap = dsl.VolumeSnapshotOp(
        name='step1_snap', resource_name='step1_snap', volume=step1.pvolume)
    ...
    step2_snap = dsl.VolumeSnapshotOp(
        name='step2_snap', resource_name='step2_snap', volume=step2.pvolume)
    ...
    step3_snap = dsl.VolumeSnapshotOp(
        name='step3_snap', resource_name='step3_snap', volume=step3.pvolume)
