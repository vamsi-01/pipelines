...
class PipelineTaskBase(abc.ABC):
    ...
    by a concrete subclass. The implementation may be to raise an Exception.

    Since the user does not construct PipelineTasks directly, we do not
    require concrete classes have the same constructor.
    """
