...
class _ConditionBase(TasksGroup):
    ...
    def __init__(
        ...
        # for subclasses may be a List[BinaryOperation], but Condition's .condition should always be a single BinaryOperation for backward compatibility
...
def _shallow_copy_list_of_binary_operations(
    ...
    # shallow copy is okay. deep not needed and would result in many copies of the full pipeline via the PipelineChannel. shallow copy allows us to invert the negate flag without affecting copies.
