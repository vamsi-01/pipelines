...
class TestIfPresentPlaceholder(unittest.TestCase):
            ...
            inputs={
                'first':
                    structures.InputSpec(
                        type='String', default=None, description=None),
                'second':
                    structures.InputSpec(
                        type='String', default=None, description=None)
            },
            outputs={
                'Output': structures.OutputSpec(
...
class TestInputSpec(unittest.TestCase):
    ...
    def test_equality(self):
        ...
        self.assertEqual(
            structures.InputSpec(type='List', description=None),
            structures.InputSpec(
                type='typing.List[typing.Dict[str, str]]', description=None))
    ...
    def test_from_ir_parameter_dict(self):
        ...
        self.assertEqual(input_spec.default, None)
        self.assertEqual(input_spec.description, None)
...
class TestOutputSpec(unittest.TestCase):
    ...
    def test_from_ir_component_dict(self):
        parameter_dict = {'parameterType': 'STRING'}
        output_spec = structures.OutputSpec.from_ir_component_dict(
            parameter_dict)
        self.assertEqual(output_spec.type, 'String')
        self.assertEqual(output_spec.description, None)
    ...
    #     {
    #         'output_1':
    #             structures.OutputSpec(type='Integer', description=None),
    #         'output_2':
    #             structures.OutputSpec(type='Model', description=None),
    #         'output_3':
    #             structures.OutputSpec(type='Artifact', description=None),
    #         'output_4':
    #             structures.OutputSpec(type='Model', description=None),
    #         'output_5':
    #             structures.OutputSpec(type='Datasets', description=None),
    #         'output_6':
    #             structures.OutputSpec(
    #                 type='Some arbitrary type', description=None),
    #         'output_7':
    #             structures.OutputSpec(
    #                 type={'GcsPath': {
    #                     'data_type': 'TSV'
    #                 }}, description=None),
    #         'output_8':
    #             structures.OutputSpec(type='HTML', description=None),
    #         'output_9':
    #             structures.OutputSpec(
    #                 type='google.BQMLModel', description=None)
    #     }
    #     outputs = {
    #         'output_1': {
...
class TestReadInComponent(parameterized.TestCase):
    ...
    def test_read_v1(self):
        ...
        self.assertEqual(component_spec.name, 'component_if')
