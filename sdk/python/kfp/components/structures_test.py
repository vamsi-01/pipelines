...
class TestOutputSpec(parameterized.TestCase):
    ...
    @parameterized.parameters([
        ...
        }, structures.OutputSpec(type='Integer')),
        ({
            'artifactType': {
                'schemaTitle': 'system.Model',
                'schemaVersion': '0.0.1'
            }
        }, structures.OutputSpec(type='Model')),
        ({
            'artifactType': {
                'schemaTitle': 'system.Artifact',
                'schemaVersion': '0.0.1'
            }
        }, structures.OutputSpec(type='Artifact')),
        ({
            'artifactType': {
                'schemaTitle': 'system.Model',
                'schemaVersion': '0.0.1'
        ...
        }, structures.OutputSpec(type='Datasets')),
        ({
            'artifactType': {
                'schemaTitle': 'system.Artifact',
                'schemaVersion': '0.0.1'
            }
        }, structures.OutputSpec(type='Some arbitrary type')),
        ({
            'artifactType': {
                'schemaTitle': 'system.Artifact',
                'schemaVersion': '0.0.1'
            }
        }, structures.OutputSpec(type={'GcsPath': {
            'data_type': 'TSV'
        }})),
        ({
            'artifactType': {
        ...
        }, structures.OutputSpec(type='HTML')),
        ({
            'artifactType': {
                'schemaTitle': 'google.BQMLModel',
                'schemaVersion': '0.0.1'
            }
        }, structures.OutputSpec(type='google.BQMLModel')),
    ])
    def test_from_ir_parameter_dict_many_cases(self, parameter_dict, expected):
        actual = structures.OutputSpec.from_ir_parameter_dict(parameter_dict)
