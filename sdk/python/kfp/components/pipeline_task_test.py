...
# x = structures.ComponentSpec.from_dict(yaml.safe_load(V2_YAML), by_alias=True)
# print(x.to_pipeline_spec())

# from kfp import compiler

# compiler.Compiler()._write_pipeline_spec_file(x.to_pipeline_spec(), 'test.yaml')
