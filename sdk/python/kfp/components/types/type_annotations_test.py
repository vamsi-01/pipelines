...
class TestIsArtifact(parameterized.TestCase):
    ...
    def test_true_class(self, obj):
        self.assertTrue(dsl_type_annotations.is_artifact_class(obj))
    ...
    def test_false(self, obj):
        self.assertFalse(dsl_type_annotations.is_artifact_class(obj))
    ...
    def test_false_no_schema_title(self):
        ...
        self.assertFalse(dsl_type_annotations.is_artifact_class(NotArtifact))
