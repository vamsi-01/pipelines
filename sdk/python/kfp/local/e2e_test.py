...
These contain two tests of various component definitions/types,
parameterized for each local runner types.

These can be thought of as local runner conformance tests. Irrespective of the local runner type, the test results should be the same.
"""
import itertools
...
class TestLightweightPythonComponentLogic(
    ...
    def test_str_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_int_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_float_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_bool_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_list_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_dict_input(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_multiple_parameter_outputs(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
        from typing import NamedTuple
    ...
    def test_single_output_not_available(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
        from typing import NamedTuple
    ...
    def test_single_artifact_output_traditional(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_single_artifact_output_pythonic(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_multiple_artifact_outputs_traditional(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_multiple_artifact_outputs_pythonic(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_str_input_uses_default(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_placeholder_default_resolved(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_int_input_uses_default(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_outputpath(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
    ...
    def test_user_code_throws_exception(self, runner, cleanup):
        local.init(runner=runner, cleanup=cleanup)
