...
class TestGetImporterUri(unittest.TestCase):
                ...
                'artifacts': {
                    'artifact': {
                        'artifacts': [{
                            ...
                            'uri':
                                '/Users/cjmccarthy/workspace/pipelines/local_outputs/my-pipeline-2024-01-24-14-56-54-309000/importer/artifact',
                            'metadata': {}
                        }]
                    }
                },
                'outputFile':
                    '/Users/cjmccarthy/workspace/pipelines/local_outputs/my-pipeline-2024-01-24-14-56-54-309000/importer/executor_output.json'
            }
        }
                ...
                'artifacts': {
                    'artifact': {
                        'artifacts': [{
                            ...
                            'uri':
                                '/Users/cjmccarthy/workspace/pipelines/local_outputs/my-pipeline-2024-01-24-15-01-15-217403/importer/artifact',
                            'metadata': {}
                        }]
                    }
                },
                'outputFile':
                    '/Users/cjmccarthy/workspace/pipelines/local_outputs/my-pipeline-2024-01-24-15-01-15-217403/importer/executor_output.json'
            }
        }
        executor_input = pipeline_spec_pb2.ExecutorInput()
        json_format.ParseDict(executor_input_dict, executor_input)
    ...
    def test_constant_warns(self):
        ...
        with self.assertWarnsRegex(
                UserWarning,
                r"It looks like you're using the remote file 'gs://foo/bar' in a 'dsl\.importer'\. Note that you will only be able to read and write to/from local files using 'artifact\.path' when running a pipeline locally\."
        ):
            uri = importer_handler.get_importer_uri(
                importer_spec=importer_spec,
                executor_input=executor_input,
    ...
    def test_runtime_parameter_warns(self):
        ...
        with self.assertWarnsRegex(
                UserWarning,
                r"It looks like you're using the remote file 's3://fizz/buzz' in a 'dsl\.importer'\. Note that you will only be able to read and write to/from local files using 'artifact\.path' when running a pipeline locally\."
        ):
            uri = importer_handler.get_importer_uri(
                importer_spec=importer_spec,
                executor_input=executor_input,
...
class TestGetArtifactClassForSchemaTitle(unittest.TestCase):
    ...
    def test_artifact(self):
        actual = importer_handler.get_artifact_class_for_schema_title(
            'system.Artifact')
