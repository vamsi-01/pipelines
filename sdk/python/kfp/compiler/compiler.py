...
class Compiler:
    """The Compiler compiles pipelines composed using the KFP SDK DSL to
    PipelineSpec IR, the protobuf message that defines a pipeline (https://gith
    ub.com/kubeflow/pipelines/blob/2060e38c5591806d657d85b53eed2eef2e5de2ae/api
    .

    /v2alpha1/pipeline_spec.proto#L50).
    ...
    def compile(
        ...
        Args:
            pipeline_func (Union[Callable[..., Any], base_component.BaseComponent]): Pipeline function constructed with the @dsl.pipeline or component with @dsl.component decorator.
            package_path (str): The output pipeline spec .yaml file path. For example, '~/my_pipeline.yaml' or '~/my_component.yaml'.
            pipeline_name (Optional[str], optional): The name of the pipeline. Defaults to None.
            pipeline_parameters (Optional[Dict[str, Any]], optional): Map of parameter names to argument values. Defaults to None.
            type_check (bool, optional): Whether to enable type checking of component interfaces during compilation. Defaults to True.
        """
