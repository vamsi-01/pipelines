...
def text_dataset_create(
  ...
  # fmt: off
  """Creates a new text [Dataset](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.datasets) and optionally imports data into Dataset when
  ...
  Returns:
      dataset: Instantiated representation of the managed text Datasetresource.
  """
  # fmt: on
