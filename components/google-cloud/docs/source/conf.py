...
# source_parsers = {
#     '.md': 'sphinx_markdown_parser.parser.MarkdownParser',
#     '.py': 'sphinx_markdown_parser.parser.MarkdownParser',
# }
...
html_theme_options = {
    ...
    'version_dropdown':
        True,
    'version_json':
        'https://raw.githubusercontent.com/kubeflow/pipelines/test-gcpc-dropdown/versions.json',
